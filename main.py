...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_ic2015', action='store_true', default=False)
    parser.add_argument('--test_svt', action='store_true', default=False)
    parser.add_argument('--go_test', action='store_true', default=False)
    parser.add_argument('--test', action='store_true', default=False)
    parser.add_argument('--test_data_dir', type=str, default='./dataset/ICDAR2015/test/', help='')
